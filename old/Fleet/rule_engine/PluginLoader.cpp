...
std::vector<std::tuple<std::string, std::string,std::string,std::string,SeverityLevel, bool, std::function<bool(const ProcessEvent&, Event&)>>> PluginLoader::ProcessEventRules(std::string plugin_name)
{
