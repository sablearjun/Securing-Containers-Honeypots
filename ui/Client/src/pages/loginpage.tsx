    ...
    doSignIn(req)
      .then((res) => {
        ...
        if (res.errors) {
          ...
          let x = res.data.token.split(' ')[1];
          localStorage.setItem("Token", x);
          localStorage.setItem("Renew_access_token", res.data.renew_access_token);
          localStorage.setItem("Username", res.data.user_data["username"]);
